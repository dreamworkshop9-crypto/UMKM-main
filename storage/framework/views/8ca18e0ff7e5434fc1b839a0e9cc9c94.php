<?php $__env->startSection('title', 'Data Produk - SALZA'); ?>
<?php $__env->startSection('page-title', 'Data Produk'); ?>
...
<div class="bg-[#1c1c2d] rounded-xl border border-outline-variant/20 overflow-hidden">
    <div class="p-6 border-b border-slate-700/50 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.produk.create')); ?>" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold rounded-lg transition-colors flex items-center gap-2 shadow-md shadow-purple-500/20">
...
(() => {
    ...
    const API = {
        list:'<?php echo e(route("admin.produk.list")); ?>',options:'<?php echo e(route("admin.produk.options")); ?>',
        show:id=>`<?php echo e(route("admin.produk.show","ID")); ?>`.replace('ID',id),
        update:id=>`<?php echo e(route("admin.produk.update","ID")); ?>`.replace('ID',id),
        delete:id=>`<?php echo e(route("admin.produk.destroy","ID")); ?>`.replace('ID',id),
    };
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKM/UMKM-main/resources/views/admin/produk/index.blade.php ENDPATH**/ ?>