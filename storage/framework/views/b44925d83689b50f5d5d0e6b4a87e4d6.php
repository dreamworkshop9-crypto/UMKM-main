<?php $__env->startSection('title', 'Kategori - SALZA'); ?>
...
var API = {
    list:   '<?php echo e(route("admin.kategori.list")); ?>',
    store:  '<?php echo e(route("admin.kategori.store")); ?>',
    show:   function(id){ return '<?php echo e(route("admin.kategori.show", "ID")); ?>'.replace('ID', id); },
    update: function(id){ return '<?php echo e(route("admin.kategori.update", "ID")); ?>'.replace('ID', id); },
    delete: function(id){ return '<?php echo e(route("admin.kategori.destroy", "ID")); ?>'.replace('ID', id); }
};
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKM/UMKM-main/resources/views/admin/kategori/index.blade.php ENDPATH**/ ?>