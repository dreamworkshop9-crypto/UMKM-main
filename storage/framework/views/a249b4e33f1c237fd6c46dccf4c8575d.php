...
<div class="max-w-[1200px] mx-auto space-y-6">
    ...
    <div class="bg-[#1c1c2d] rounded-2xl border border-outline-variant/20 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
        ...
        <div class="bg-slate-900/60 border border-outline-variant/20 px-4 py-2 rounded-xl flex items-center gap-2 text-xs text-slate-400">
            ...
            <span class="font-semibold"><?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F Y')); ?></span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-[#1c1c2d] rounded-2xl p-5 border border-outline-variant/20 shadow-xl flex items-center gap-4 hover:border-emerald-500/30 transition-all group">
            ...
            <div class="space-y-1">
                ...
                <h3 class="text-white text-lg font-extrabold font-mono">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h3>
        ...
        <div class="bg-[#1c1c2d] rounded-2xl p-5 border border-outline-variant/20 shadow-xl flex items-center gap-4 hover:border-indigo-500/30 transition-all group">
            ...
            <div class="space-y-1">
                ...
                <h3 class="text-white text-lg font-extrabold font-mono"><?php echo e(number_format($totalOrders, 0, ',', '.')); ?></h3>
        ...
        <div class="bg-[#1c1c2d] rounded-2xl p-5 border border-outline-variant/20 shadow-xl flex items-center gap-4 hover:border-amber-500/30 transition-all group">
            ...
            <div class="space-y-1">
                ...
                <h3 class="text-white text-lg font-extrabold font-mono"><?php echo e(number_format($pendingOrders, 0, ',', '.')); ?></h3>
        ...
        <div class="bg-[#1c1c2d] rounded-2xl p-5 border border-outline-variant/20 shadow-xl flex items-center gap-4 hover:border-cyan-500/30 transition-all group">
            ...
            <div class="space-y-1">
                ...
                <h3 class="text-white text-lg font-extrabold font-mono"><?php echo e(number_format($totalProducts, 0, ',', '.')); ?></h3>
        ...
        <div class="lg:col-span-2 bg-[#1c1c2d] rounded-2xl border border-outline-variant/20 shadow-xl overflow-hidden flex flex-col justify-between">
            <div>
                <div class="px-6 py-5 border-b border-outline-variant/10 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.pesanan.masuk')); ?>" class="text-[11px] text-indigo-400 hover:text-indigo-300 font-bold flex items-center gap-1 transition-colors">
                        ...
                        <tbody class="divide-y divide-outline-variant/5">
                            ...
                            <tr class="hover:bg-[#1a1a2e] transition-colors">
                                <td class="px-6 py-3.5">
                                    <span class="font-mono text-xs font-semibold text-slate-300"><?php echo e($order->invoice); ?></span>
                                </td>
                                ...
                                <td class="px-6 py-3.5 text-center">
                                    ...
                                    ?>
                                    <span class="text-[9px] font-bold px-2.5 py-0.5 rounded-full border <?php echo e($bc[$order->status] ?? 'bg-slate-500/10 text-slate-400'); ?> uppercase">
                                        <?php echo e($order->status); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-3.5 text-center">
                                    <a href="<?php echo e(route('admin.pesanan.show', $order->id)); ?>" class="w-7 h-7 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 flex items-center justify-center text-indigo-400 hover:text-indigo-300 transition-colors mx-auto" title="Detail Pesanan">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $bestSellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex items-center gap-3.5 pb-3 border-b border-outline-variant/5 last:border-0 last:pb-0">
                            <div class="w-11 h-11 rounded-lg bg-[#121220] border border-outline-variant/20 flex items-center justify-center overflow-hidden flex-shrink-0">
                                <img src="<?php echo e($item->product->thumbnail_url ?? asset('images/default-product.png')); ?>" alt="<?php echo e($item->product->name); ?>" class="w-full h-full object-cover">
                            </div>
                            <div class="flex-1 min-w-0">
                                ...
                                <span class="text-[10px] text-slate-500 font-medium block mt-0.5">
                                    Total Omset: <span class="text-emerald-400 font-bold font-mono">Rp <?php echo e(number_format($item->total_revenue, 0, ',', '.')); ?></span>
                                </span>
                            </div>
                            <div class="flex-shrink-0 text-right">
                                <span class="text-[10px] font-bold px-2.5 py-1 rounded-full border border-purple-500/20 bg-purple-500/10 text-purple-400">
                                    <?php echo e($item->total_sold); ?> Terjual
                                </span>
                            </div>
                        </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKM/UMKM-main/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>