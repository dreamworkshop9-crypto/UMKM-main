...
<div class="max-w-[1200px] mx-auto bg-[#1c1c2d] rounded-2xl border border-outline-variant/20 shadow-xl overflow-hidden">
    ...
    <div class="p-8">
        ...
        <form id="form-produk" method="POST" action="<?php echo e(route('admin.produk.update', $produk->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                <div class="space-y-2">
                    ...
                    <input type="text" id="nama" name="name" value="<?php echo e(old('name', $produk->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div id="slug" class="w-full bg-[#121220] border border-outline-variant/30 rounded-lg px-4 py-3 text-slate-500 text-[13px] truncate"><?php echo e(old('slug', $produk->slug)); ?></div>
                    <input type="hidden" name="slug" id="slug-input" value="<?php echo e(old('slug', $produk->slug)); ?>"/>
                </div>
            </div>
                ...
                <div class="space-y-2">
                    ...
                    <select id="brand_id" name="brand_id" required
                        ...
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($brand->id); ?>" <?php echo e(old('brand_id', $produk->brand_id) == $brand->id ? 'selected' : ''); ?> class="bg-[#121220]">
                ...
                <div class="space-y-2">
                    ...
                    <select id="kategori_id" name="kategori_id" required
                        ...
                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kategori->id); ?>" <?php echo e(old('kategori_id', $produk->kategori_id) == $kategori->id ? 'selected' : ''); ?> class="bg-[#121220]">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                <div class="space-y-2">
                    ...
                    <input type="number" name="price" value="<?php echo e(old('price', $produk->price)); ?>" required min="0"
                        class="w-full bg-[#121220] border border-outline-variant/30 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all outline-none text-[13px]"
                        placeholder="0"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="stock" value="<?php echo e(old('stock', $produk->stock)); ?>" required min="0"
                        class="w-full bg-[#121220] border border-outline-variant/30 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all outline-none text-[13px]"
                        placeholder="0"/>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-5 space-y-2">
                ...
                <div id="size-list" class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = old('sizes', $produk->sizes ?? ['']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-5 space-y-2">
                ...
                <div id="color-list" class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = old('colors', $produk->colors ?? ['']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-2">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-5 space-y-2">
                ...
                <div id="gambar-preview" class="mt-3 <?php echo e($produk->image ? '' : 'hidden'); ?>">
                    <div class="bg-[#121220] rounded-xl p-2 border border-outline-variant/20 inline-block w-fit">
                        <img id="gambar-preview-img" class="max-h-[180px] rounded-lg object-contain" 
                            src="<?php echo e($produk->image ? Storage::url($produk->image) : ''); ?>" alt="Preview"/>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-5 space-y-2">
                ...
                <textarea name="description" rows="4"
                    ...
                    placeholder="Tulis deskripsi produk..."><?php echo e(old('description', $produk->description)); ?></textarea>
...
function previewImg(input) {
    ...
    if (input.files.length > 0) {
        ...
        <?php if($produk->image): ?>
            previewImg.src = "<?php echo e(Storage::url($produk->image)); ?>";
            preview.classList.remove('hidden');
        <?php else: ?>
...
document.getElementById('form-produk').addEventListener('submit', function(e) {
    ...
    .then(data => {
        ...
        setTimeout(() => {
            window.location.href = '<?php echo e(route("admin.produk")); ?>';
        }, 1500);
    })
    .catch(err => {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKM/UMKM-main/resources/views/admin/produk/edit.blade.php ENDPATH**/ ?>