...
<title><?php echo $__env->yieldContent('title', 'Salza Admin'); ?> - Admin</title>
...
<!-- Dashboard -->
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-active-gradient text-white shadow-lg shadow-indigo-500/20' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all" href="<?php echo e(route('admin.dashboard')); ?>">
<span class="material-symbols-outlined text-[20px]">dashboard</span>
<span class="text-[13px] <?php echo e(request()->routeIs('admin.dashboard') ? 'font-semibold' : 'font-medium'); ?>">Dashboard</span>
</a>

<!-- Data Master -->
<div class="px-4 py-2 text-[10px] font-bold text-slate-600 uppercase tracking-widest">Data Master</div>
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.brands.index') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.brands.index')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.kategori') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.kategori')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.produk') || request()->routeIs('admin.produk.*') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.produk')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.shipping.*') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.shipping.index')); ?>">
...
<div onclick="togglePesanan()" class="flex items-center justify-between <?php echo e(request()->routeIs('admin.pesanan.*') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all cursor-pointer select-none">
<div class="flex items-center gap-3">
<span class="material-symbols-outlined text-[20px]">list_alt</span>
<span class="text-[13px] font-medium">Pesanan</span>
</div>
<span id="pesanan-arrow" class="material-symbols-outlined text-[16px] transition-transform duration-200 <?php echo e(request()->routeIs('admin.pesanan.*') ? '' : ''); ?>" style="<?php echo e(request()->routeIs('admin.pesanan.*') ? 'transform:rotate(180deg)' : ''); ?>">expand_more</span>
</div>


<div id="pesanan-submenu" class="pl-6 space-y-1 mt-1 mb-1 <?php echo e(request()->routeIs('admin.pesanan.*') ? '' : 'hidden'); ?>">
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.pesanan.masuk') ? 'text-white font-medium' : 'text-slate-400 hover:text-white'); ?> px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.masuk')); ?>">
<span class="material-symbols-outlined text-[14px]"><?php echo e(request()->routeIs('admin.pesanan.masuk') ? 'arrow_forward' : 'more_horiz'); ?></span><span>Pesanan Masuk</span>
</a>
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.pesanan.dikonfirmasi') ? 'text-white font-medium' : 'text-slate-400 hover:text-white'); ?> px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.dikonfirmasi')); ?>">
<span class="material-symbols-outlined text-[14px] <?php echo e(request()->routeIs('admin.pesanan.dikonfirmasi') ? '' : 'text-indigo-400/50'); ?>"><?php echo e(request()->routeIs('admin.pesanan.dikonfirmasi') ? 'arrow_forward' : 'more_horiz'); ?></span><span>Pesanan Di Konfirmasi</span>
</a>
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.pesanan.dikemas') ? 'text-white font-medium' : 'text-slate-400 hover:text-white'); ?> px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.dikemas')); ?>">
<span class="material-symbols-outlined text-[14px] <?php echo e(request()->routeIs('admin.pesanan.dikemas') ? '' : 'text-indigo-400/50'); ?>"><?php echo e(request()->routeIs('admin.pesanan.dikemas') ? 'arrow_forward' : 'more_horiz'); ?></span><span>Pesanan Di Kemas</span>
</a>
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.pesanan.dikirim') ? 'text-white font-medium' : 'text-slate-400 hover:text-white'); ?> px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.dikirim')); ?>">
<span class="material-symbols-outlined text-[14px] <?php echo e(request()->routeIs('admin.pesanan.dikirim') ? '' : 'text-indigo-400/50'); ?>"><?php echo e(request()->routeIs('admin.pesanan.dikirim') ? 'arrow_forward' : 'more_horiz'); ?></span><span>Pesanan Dikirim</span>
</a>
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.pesanan.diperjalanan') ? 'text-white font-medium' : 'text-slate-400 hover:text-white'); ?> px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.diperjalanan')); ?>">
<span class="material-symbols-outlined text-[14px] <?php echo e(request()->routeIs('admin.pesanan.diperjalanan') ? '' : 'text-indigo-400/50'); ?>"><?php echo e(request()->routeIs('admin.pesanan.diperjalanan') ? 'arrow_forward' : 'more_horiz'); ?></span><span>Pesanan Dalam Perjalanan</span>
</a>
<a class="flex items-center gap-3 <?php echo e(request()->routeIs('admin.pesanan.selesai') ? 'text-white font-medium' : 'text-slate-400 hover:text-white'); ?> px-4 py-2 rounded-lg text-[12px] transition-all" href="<?php echo e(route('admin.pesanan.selesai')); ?>">
<span class="material-symbols-outlined text-[14px] <?php echo e(request()->routeIs('admin.pesanan.selesai') ? '' : 'text-indigo-400/50'); ?>"><?php echo e(request()->routeIs('admin.pesanan.selesai') ? 'arrow_forward' : 'more_horiz'); ?></span><span>Pesanan Selesai</span>
</a>
</div>

<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.pembatalan') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.pembatalan')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.pengembalian') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.pengembalian')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.ulasan') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.ulasan')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.stok') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.stok')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.users') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.users')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.payment.*') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.payment.index')); ?>">
...
<a class="flex items-center justify-between <?php echo e(request()->routeIs('admin.laporan') ? 'text-white' : 'text-slate-400 hover:text-white'); ?> px-4 py-2.5 rounded-lg transition-all group" href="<?php echo e(route('admin.laporan')); ?>">
...
<div class="flex items-center gap-6">
    ...
    <div id="admin-notification-badge" class="relative cursor-pointer group flex items-center justify-center mr-2">
        <a href="<?php echo e(route('admin.pesanan.masuk')); ?>" onclick="event.preventDefault(); navigateTo('<?php echo e(route('admin.pesanan.masuk')); ?>')">
    ...
    <div class="relative">
        <button id="admin-profile-btn" onclick="toggleAdminProfileDropdown()" class="flex items-center gap-2 focus:outline-none group">
            <img alt="Profile" class="w-8 h-8 rounded-full border border-indigo-500/30 object-cover hover:border-indigo-400 transition-all" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name ?? 'Admin')); ?>&background=6366f1&color=fff"/>
            <span class="text-xs text-slate-400 group-hover:text-white transition-colors font-medium"><?php echo e(Auth::user()->name ?? 'Admin'); ?></span>
        ...
        <div id="admin-profile-dropdown" class="hidden absolute right-0 mt-2.5 w-48 bg-[#1c1c2d] border border-outline-variant/30 rounded-xl shadow-2xl z-[70] py-1.5 overflow-hidden">
            <div class="px-4 py-2 border-b border-outline-variant/30">
                <p class="text-xs font-bold text-white truncate"><?php echo e(Auth::user()->name ?? 'Admin'); ?></p>
                <p class="text-[10px] text-slate-500 truncate mt-0.5"><?php echo e(Auth::user()->email ?? 'admin@salza.com'); ?></p>
            </div>
            
            <a href="<?php echo e(route('admin.dashboard')); ?>" onclick="event.preventDefault(); navigateTo('<?php echo e(route('admin.dashboard')); ?>'); closeAdminProfileDropdown()" class="flex items-center gap-2.5 px-4 py-2 text-xs text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                <span class="material-symbols-outlined text-[16px]">dashboard</span>
                <span>Dashboard</span>
            </a>
            
            <a href="<?php echo e(route('admin.profile.edit')); ?>" onclick="event.preventDefault(); navigateTo('<?php echo e(route('admin.profile.edit')); ?>'); closeAdminProfileDropdown()" class="flex items-center gap-2.5 px-4 py-2 text-xs text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                <span class="material-symbols-outlined text-[16px]">edit</span>
                <span>Edit Profil</span>
            </a>

            <div class="border-t border-outline-variant/30 mt-1.5 pt-1.5">
                <form method="POST" action="<?php echo e(route('logout')); ?>" id="dropdown-logout-form">
                    <?php echo csrf_field(); ?>
...
<span class="material-symbols-outlined text-[18px]">check_circle</span><?php echo e(session('success')); ?>
...
<span class="material-symbols-outlined text-[18px]">error</span><?php echo e(session('error')); ?>
...
<div>&copy; <?php echo e(date('Y')); ?> <span class="text-indigo-400">Salza E-commerce</span>. All Rights Reserved.</div>
...
</html><?php /**PATH /home/irawan/laravel/shoesmarket/UMKM/UMKM-main/resources/views/layouts/admin.blade.php ENDPATH**/ ?>