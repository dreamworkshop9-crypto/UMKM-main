<?php $__env->startSection('title','Masuk - SALZA'); ?>
...
<div class="bg-slate-800/60 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-2xl p-8">
    ...
    <div class="bg-red-500/10 border border-red-500/20 text-red-400 text-sm px-4 py-3 rounded-xl mb-4">
        <i class="fa fa-exclamation-circle mr-1"></i> <?php echo e($errors->first()); ?>
    ...
    <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="email@contoh.com"
    ...
    <p class="text-center text-sm text-slate-400 mt-6">
        Belum punya akun?
        <a href="<?php echo e(route('daftar')); ?>" class="text-purple-400 hover:text-purple-300 font-medium transition-colors">Daftar sekarang</a>
    </p>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/irawan/laravel/shoesmarket/UMKM/UMKM-main/resources/views/pages/auth/login.blade.php ENDPATH**/ ?>