...
@section('title', 'Dalam Perjalanan - SALZA')
@section('page-title', 'Dalam Perjalanan')
...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-dashboard-card rounded-2xl border border-slate-700/30 overflow-hidden mb-6">
        <div class="p-6 border-b border-slate-700/50 flex items-center gap-3">
            <div class="w-8 h-8 rounded-lg bg-amber-500/20 flex items-center justify-center">
                <i class="fa-solid fa-truck text-amber-400 text-xs"></i>
            </div>
            <div>
                <h2 class="text-lg font-semibold text-white">Dalam Perjalanan</h2>
                <p class="text-xs text-slate-500 mt-0.5">Pesanan sedang dikirim ke pelanggan</p>
            </div>
        </div>
        <!-- Status badge -->
        <div class="px-6 border-b border-slate-700/50">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20">
                <span class="w-2 h-2 rounded-full bg-amber-400 animate-pulse"></span>
                <span class="text-sm font-semibold text-amber-400">Dalam Perjalanan</span>
            </div>
        </div>
        <!-- Detail pesanan -->
    ...
    <!-- Tombol -->
    <div class="bg-dashboard-card rounded-2xl border border-amber-500/30 overflow-hidden">
        <div class="p-6">
            <div class="border border-amber-500/20 bg-amber-500/5 rounded-xl border-dashed border-l-4 pl-5 py-3 mb-5">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <p class="p-0 text-sm font-semibold text-amber-200">Pastikan data pesanan sudah benar sebelum mengubah status.</p>
                </div>
            </div>
            <div class="flex gap-3">
                ...
                <button type="button" id="statusBtn" class="flex-1 py-2.5 bg-amber-600 hover:bg-amber-700 text-white text-sm font-bold rounded-lg shadow-md shadow-amber-500/20 hover:shadow-lg hover:shadow-amber-500/30 transition-all flex items-center justify-center gap-2">
                    <i class="fa-solid fa-truck text-xs"></i>Status Perjalanan
                </button>
            </div>
        </div>
    </div>
