...
@section('title', 'Dikemas - SALZA')
@section('page-title', 'Dikemas Pesanan')
...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-dashboard-card rounded-2xl border border-slate-700/30 overflow-hidden mb-6">
        <div class="border-b border-slate-700/50 px-6 py-4 flex items-center gap-3">
            <div class="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center">
                <i class="fa-solid fa-box-open text-purple-400 text-xs"></i>
            </div>
            <div>
                <h2 class="text-lg font-semibold text-white">Dikemas</h2>
                <p class="text-xs text-slate-500 mt-0.5">Pesanan sedang dalam proses pengemasan</p>
            </div>
        </div>
        <!-- Detail pesanan -->
    ...
    <!-- Tombol -->
    <div class="bg-dashboard-card rounded-2xl border border-purple-500/30 overflow-hidden">
        <div class="p-6">
            <div class="border border-amber-500/20 bg-amber-500/5 rounded-xl border-dashed border-l-4 pl-5 py-3 mb-5">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <p class="p-0 text-sm font-semibold text-amber-200">Pastikan pesanan sudah benar sebelum mengubah status.</p>
                </div>
            </div>
            <div class="flex gap-3">
                ...
                <button type="button" id="statusBtn" class="flex-1 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-bold rounded-lg shadow-md shadow-purple-500/20 hover:shadow-lg hover:shadow-purple-500/30 transition-all flex items-center justify-center gap-2">
                    <i class="fa-solid fa-box-open text-xs"></i>Status Dikemas
                </button>
            </div>
        </div>
    </div>
